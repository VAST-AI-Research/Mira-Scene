...
# Adapted from https://github.com/huggingface/diffusers/blob/v0.34.0/src/diffusers/schedulers/scheduling_flow_match_euler_discrete.py
...
class FlowMatchEulerDiscreteScheduler(SchedulerMixin, ConfigMixin):
    ...
    def scale_noise(
        ...
        sigma: Optional[Union[float, torch.FloatTensor]] = None,
    ) -> torch.FloatTensor:
        """
        ...
        if self.config.invert_sigmas:  # NOTE: sigma 0 for noise, 1 for clean latents
            sigma = 1.0 - sigma
    ...
    def step(
        ...
        Args:
            ...
            advance_step_index (`bool`, defaults to `True`):
                Whether to advance the step index after the step. Useful when running multiple steps for the same timestep
                (e.g. for different modalities).
    ...
    def _time_shift_constant(self, t):
